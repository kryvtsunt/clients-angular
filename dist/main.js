...
var ClientInfoComponent = /** @class */ (function () {
    ...
    ClientInfoComponent.prototype.getClientById = function (id) {
        ...
        this.service.getClientById(id)
            .then(function (res) { _this.client = res[0]; console.log(_this.client); });
    };
